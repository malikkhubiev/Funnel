...
const quizData = [
  {
    ...
    question: 'Мы заметили прямую связь между Числом пожарных🚒 и Величиной разрушений💥. Значит ли это, что для тушения пожара нужно звать как можно меньше пожарных?🔥✅🔥',
  ...
  },
  {
    ...
    answer: 'Ответ: Выборка была смещена: опрашивали владельцев телефонов/подписчиков — в основном богатых, не репрезентативно.<br>Если в дорогом отеле в Дубае 0% опрошенных едят быстрорастворимую лапшу, это не значит, что в 2025 году её больше не покупают.'
  },
  {
    type: 'choice',
...
function renderStep(container, stepIndex, onDone) {
  ...
  if (stepIndex >= quizData.length) {
    ...
    h.textContent = 'Поздравляем! Вы прошли тест 🎉';
